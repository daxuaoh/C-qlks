...
namespace HotelManager.DTO
{
    public class Account
    {
        ...
        //private string sex;
        //private string address;
        //private strng phoneNumber;
        //private DateTime startDay;
        //public Account(string username,string displayname,string password,int idstafftype,string idcard, DateTime dateofbirth,string sex,string address,string phonenumber,DateTime startday)
        //{
        //    this.UserName = username;
        //    this.DisplayName = displayname;
        //    this.PassWord = password;
