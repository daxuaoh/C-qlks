    ...
    public partial class fStaff : Form
    {
        ...
        private DataTable GetSearchStaff()
        {
            if (!string.IsNullOrWhiteSpace(txbPhoneNumber.Text))
                return AccountDAO.Instance.Search(txbSearch.Text, txbPhoneNumber.Text);
            else
                return AccountDAO.Instance.Search(txbSearch.Text, "");
            //int.TryParse(txbSearch.Text, out int phoneNumber)
        }
        #endregion
        ...
        private void txbPhoneNumber_OnValueChanged(object sender, EventArgs e)
        {
